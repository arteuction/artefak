...
### Приет модел: `80 / 10 / 10`

| Получател | Дял | Basis points | Описание |
|-----------|-----|--------------|----------|
| **Автор** | 80 % | 8 000 bps | Основен приход от продажбата |
| **Платформа** | 10 % | 1 000 bps | Операционни разходи (Artefak) |
| **SDG кауза** | 10 % | 1 000 bps | Социален / екологичен фонд, свързан с книгата |

**Профилен ключ:** `library_80_10_10` · **Версия:** 1

**Правило:** split профилът се замразява при момента на продажбата.
Промяна в платформения модел не засяга минали транзакции.

**Разлика от ArteUction (45/45/10):** дигиталната библиотека е авторски marketplace —
авторите очакват стандартни marketplace условия (70–80 %). 10 % за SDG каузата
запазва социалния компонент без да намалява авторския дял под пазарния праг.
